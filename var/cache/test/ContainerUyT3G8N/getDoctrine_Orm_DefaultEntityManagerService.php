...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelTestDebugContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['doctrine.orm.default_entity_manager'] = $container->createProxy('EntityManagerGhost07d86ea', static fn () => \EntityManagerGhost07d86ea::createLazyGhost(static fn ($proxy) => self::do($container, $proxy)));
        }
